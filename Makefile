...
TOPLEVEL_CONFIGURE_ARGUMENTS=./configure --enable-targets=all
...
BUILD_CONFIGARGS =  --cache-file=./config.cache '--enable-targets=all' --program-transform-name='s,y,y,' --disable-option-checking --disable-year2038 --with-build-subdir="$(BUILD_SUBDIR)"
...
SUBDIRS =  libiberty opcodes bfd readline zlib libbacktrace libdecnumber libctf libsframe binutils gas ld sim gdb gdbserver gprof etc gprofng gnulib gdbsupport
TARGET_CONFIGDIRS = 
# This is set by the configure script to the arguments to use when configuring
# directories built for the host system.
HOST_CONFIGARGS =  --cache-file=./config.cache  --with-gnu-as --with-gnu-ld '--enable-targets=all' --program-transform-name='s,y,y,' --disable-option-checking --disable-year2038
...
TARGET_CONFIGARGS = --cache-file=./config.cache --enable-multilib   '--enable-targets=all' --program-transform-name='s,y,y,' --disable-option-checking --disable-year2038 --with-target-subdir="$(TARGET_SUBDIR)"
# This is the list of variables to export in the environment when
