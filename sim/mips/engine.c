  ...
  while (1)
    {
      ...
      switch (EXTRACTED32 (instruction_0, 31, 26))
          ...
          {
            {
              switch (EXTRACTED32 (instruction_0, 5, 0))
                ...
                case 20:
                  {
                    nia = semantic_DSLLV_SPECIAL (sd, instruction_0, cia);
                    break;
                  }
                case 22:
                  {
                    nia = semantic_DSRLV_SPECIAL (sd, instruction_0, cia);
                    break;
                  }
                case 23:
                  {
                    nia = semantic_DSRAV_SPECIAL (sd, instruction_0, cia);
                    break;
                  }
                case 24:
                  {
                ...
                case 28:
                  {
                    nia = semantic_DMULT_SPECIAL (sd, instruction_0, cia);
                    break;
                  }
                case 29:
                  {
                    nia = semantic_DMULTU_SPECIAL (sd, instruction_0, cia);
                    break;
                  }
                case 30:
                  {
                    nia = semantic_DDIV_SPECIAL (sd, instruction_0, cia);
                    break;
                  }
                case 31:
                  {
                    nia = semantic_DDIVU_SPECIAL (sd, instruction_0, cia);
                    break;
                  }
                case 32:
                  {
                ...
                case 44:
                  {
                    nia = semantic_DADD_SPECIAL (sd, instruction_0, cia);
                    break;
                  }
                case 45:
                  {
                    nia = semantic_DADDU_SPECIAL (sd, instruction_0, cia);
                    break;
                  }
                case 46:
                  {
                    nia = semantic_DSUB_SPECIAL (sd, instruction_0, cia);
                    break;
                  }
                case 47:
                  {
                    nia = semantic_DSUBU_SPECIAL (sd, instruction_0, cia);
                    break;
                  }
                case 48:
                  {
                ...
                case 56:
                  {
                    nia = semantic_DSLL_SPECIAL (sd, instruction_0, cia);
                    break;
                  }
                case 57:
                  {
                ...
                case 58:
                  {
                    nia = semantic_DSRL_SPECIAL (sd, instruction_0, cia);
                    break;
                  }
                case 59:
                  {
                    nia = semantic_DSRA_SPECIAL (sd, instruction_0, cia);
                    break;
                  }
                case 60:
                  {
                    nia = semantic_DSLL32_SPECIAL (sd, instruction_0, cia);
                    break;
                  }
                case 62:
                  {
                    nia = semantic_DSRL32_SPECIAL (sd, instruction_0, cia);
                    break;
                  }
                case 63:
                  {
                    nia = semantic_DSRA32_SPECIAL (sd, instruction_0, cia);
                    break;
                  }
                default:
                  ...
                  {
                    {
                      switch (EXTRACTED32 (instruction_0, 17, 16))
                        ...
                        case 0:
                          {
                            {
                              switch (EXTRACTED32 (instruction_0, 24, 21))
                                {
                                case 0:
                                  {
                                ...
                                case 1:
                                  {
                                    nia = semantic_DMFC0_COP0 (sd, instruction_0, cia);
                                    break;
                                  }
                                case 4:
                                  {
                                ...
                                case 5:
                                  {
                                    nia = semantic_DMTC0_COP0 (sd, instruction_0, cia);
                                    break;
                                  }
                                case 8:
                                  {
                  ...
                  {
                    {
                      switch (EXTRACTED32 (instruction_0, 25, 21))
                        ...
                        case 1:
                          {
                            nia = semantic_DMFC1b_COP1 (sd, instruction_0, cia);
                            break;
                          }
                        case 2:
                          {
                        ...
                        case 5:
                          {
                            nia = semantic_DMTC1b_COP1 (sd, instruction_0, cia);
                            break;
                          }
                        case 6:
                          {
          ...
          {
            {
              switch (EXTRACTED32 (instruction_0, 5, 0))
                ...
                case 1:
                  {
                    nia = semantic_LDXC1_COP1X (sd, instruction_0, cia);
                    break;
                  }
                case 8:
                  {
                ...
                case 9:
                  {
                    nia = semantic_SDXC1_COP1X (sd, instruction_0, cia);
                    break;
                  }
                case 15:
                  {
        ...
        case 24:
          {
            nia = semantic_DADDI_NORMAL (sd, instruction_0, cia);
            break;
          }
        case 25:
          {
            nia = semantic_DADDIU_NORMAL (sd, instruction_0, cia);
            break;
          }
        case 26:
          {
            nia = semantic_LDL_NORMAL (sd, instruction_0, cia);
            break;
          }
        case 27:
          {
            nia = semantic_LDR_NORMAL (sd, instruction_0, cia);
            break;
          }
        case 28:
        case 29:
        ...
        case 39:
          {
            nia = semantic_LWU_NORMAL (sd, instruction_0, cia);
            break;
          }
        case 40:
          {
        ...
        case 44:
          {
            nia = semantic_SDL_NORMAL (sd, instruction_0, cia);
            break;
          }
        case 45:
          {
            nia = semantic_SDR_NORMAL (sd, instruction_0, cia);
            break;
          }
        case 46:
          {
        ...
        case 52:
          {
            nia = semantic_LLD_NORMAL (sd, instruction_0, cia);
            break;
          }
        case 53:
          {
        ...
        case 54:
          {
            nia = semantic_LDCz_NORMAL (sd, instruction_0, cia);
            break;
          }
        case 55:
          {
            nia = semantic_LD_NORMAL (sd, instruction_0, cia);
            break;
          }
        case 56:
          {
        ...
        case 60:
          {
            nia = semantic_SCD_NORMAL (sd, instruction_0, cia);
            break;
          }
        case 61:
          {
        ...
        case 62:
          {
            nia = semantic_SDCz_NORMAL (sd, instruction_0, cia);
            break;
          }
        case 63:
          {
            nia = semantic_SD_NORMAL (sd, instruction_0, cia);
            break;
          }
        default:
          sim_engine_abort (SD, CPU, cia, "Internal error - bad switch generated");
