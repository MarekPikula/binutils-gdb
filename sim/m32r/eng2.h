...
extern ENGINE_FN m32r2f_engine_run_full;
extern ENGINE_FN m32r2f_engine_run_fast;

extern SEM_PC m32r2f_pbb_begin (SIM_CPU *, int);
extern SEM_PC m32r2f_pbb_chain (SIM_CPU *, SEM_ARG);
extern SEM_PC m32r2f_pbb_cti_chain (SIM_CPU *, SEM_ARG, SEM_BRANCH_TYPE, PCADDR);
extern void m32r2f_pbb_before (SIM_CPU *, SCACHE *);
extern void m32r2f_pbb_after (SIM_CPU *, SCACHE *);
