/* engine configuration for m32rxf */

/* WITH_FAST: non-zero if a fast version of the engine is available
   in addition to the full-featured version.  */
#define WITH_FAST 0

/* WITH_SCACHE_PBB_M32RXF: non-zero if the pbb engine was selected.  */
#define WITH_SCACHE_PBB_M32RXF 1
...
extern ENGINE_FN m32rxf_engine_run_full;
extern ENGINE_FN m32rxf_engine_run_fast;

extern SEM_PC m32rxf_pbb_begin (SIM_CPU *, int);
extern SEM_PC m32rxf_pbb_chain (SIM_CPU *, SEM_ARG);
extern SEM_PC m32rxf_pbb_cti_chain (SIM_CPU *, SEM_ARG, SEM_BRANCH_TYPE, PCADDR);
extern void m32rxf_pbb_before (SIM_CPU *, SCACHE *);
extern void m32rxf_pbb_after (SIM_CPU *, SCACHE *);
