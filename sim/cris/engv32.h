/* engine configuration for crisv32f */

/* WITH_FAST: non-zero if a fast version of the engine is available
   in addition to the full-featured version.  */
#define WITH_FAST 0

/* WITH_SCACHE_PBB_CRISV32F: non-zero if the pbb engine was selected.  */
#define WITH_SCACHE_PBB_CRISV32F 1
...
extern ENGINE_FN crisv32f_engine_run_full;
extern ENGINE_FN crisv32f_engine_run_fast;

extern SEM_PC crisv32f_pbb_begin (SIM_CPU *, int);
extern SEM_PC crisv32f_pbb_chain (SIM_CPU *, SEM_ARG);
extern SEM_PC crisv32f_pbb_cti_chain (SIM_CPU *, SEM_ARG, SEM_BRANCH_TYPE, PCADDR);
extern void crisv32f_pbb_before (SIM_CPU *, SCACHE *);
extern void crisv32f_pbb_after (SIM_CPU *, SCACHE *);
